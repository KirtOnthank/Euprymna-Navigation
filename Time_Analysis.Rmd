...
## pulling over trial details from squidtime object into squiddist
```{r}
...
```
# Making figure of relative hazard of time by run
...
# Making figure of relative hazard of distance by run
...
# making time survival curves for P3-P5 versus P2
```{r}
library(survival)
...
# making distance survival curves for P3-P5 versus P2
```{r}
library(survival)
